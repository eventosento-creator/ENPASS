...
function Fallback() {
  return <div className="absolute inset-0 overflow-hidden bg-[var(--surface)]">
    ...
    <span className="absolute bottom-5 left-5 text-xs font-black tracking-[.2em] text-white/50">ENPASS</span>
  </div>;
}
