  ...
  async sendTicketDelivery(message: TicketEmail) {
    ...
    await this.transport.sendMail({
      ...
      html: emailFrame(`
        ...
        <h1 style="margin:0 0 24px;font-size:34px;line-height:1.02;letter-spacing:-.04em">¡Tu compra está confirmada!</h1>
        ...
        <p style="margin:24px 0 0;color:#77777f;font-size:12px;line-height:1.6">El enlace es personal y vence en 15 minutos. Después podés pedir uno nuevo desde Mis accesos.</p>
      `),
    });
  }
