...
export default async function ProducerLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen pb-24 md:pb-0 md:pl-60">
    ...
    <header className="border-b border-white/[.07] px-4 py-4 md:hidden"><Link href="/app" className="whitespace-nowrap font-black tracking-[-.03em]">NIGHTLIFE OS</Link></header>
