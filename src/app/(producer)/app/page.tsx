...
export default async function DashboardPage() {
  ...
  return <>
    <div className="flex items-end justify-between gap-4"><div><p className="text-sm text-neutral-500">{organization.name}</p><h1 className="page-title mt-1">Esta es tu noche.</h1></div><Link aria-label="Nueva fecha" className="btn btn-primary" href="/app/events/new"><CalendarPlus size={18}/><span className="hidden sm:inline">Nueva fecha</span></Link></div>
