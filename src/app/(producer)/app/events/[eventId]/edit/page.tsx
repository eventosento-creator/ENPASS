...
export default async function EditEventPage({ params }: { params: Promise<{ eventId: string }> }) {
  ...
  const [{ data: venues }, { data: currentVenue }, { count: ticketCount }, { count: promoterCount }, { count: tableCount }, { count: gateCount }, { count: posCount }] = await Promise.all([
