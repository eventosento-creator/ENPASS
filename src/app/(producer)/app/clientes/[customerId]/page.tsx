...
import { CustomerNotesForm } from "@/modules/customers/ui/customer-notes-form";
...
export default async function ClientDetailPage({ params }: { params: Promise<{ customerId: string }> }) {
  ...
  return <>
    ...
    <section className="mt-8 grid items-start gap-6 xl:grid-cols-[1fr_380px]">
      <div><h2 className="section-title">Historial de compras</h2>
      ...
      <CustomerNotesForm customerId={customer.id} notes={customer.notes} tags={customer.tags}/>
    </section>
  </>;
}
