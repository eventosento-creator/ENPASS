...
export default async function UpdatePasswordPage() {
  ...
  return <main className="container-shell grid min-h-screen grid-rows-[auto_1fr] py-5 sm:py-10">
    <header className="flex items-center justify-between"><Link href="/login" className="inline-flex min-h-11 items-center gap-1 text-sm text-neutral-500 hover:text-white"><ChevronLeft size={17}/>Volver</Link><Link href="/" className="text-sm font-black tracking-[-.03em]">ENPASS</Link></header>
