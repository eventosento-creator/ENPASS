...
export const metadata: Metadata = {
  title: { absolute: "ENPASS — Eventos y entradas" },
  description: "Descubrí eventos cerca tuyo. Comprá entradas u organizá tu próxima fecha con ENPASS.",
};
